...
import '../vehicle/live_vehicle_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future getLicensePlate({required String source}) async {
    // pick an image
    ...
    var endpoint =
        ...
        apiUrl != null ? apiUrl : 'http://3174-110-54-226-65.ngrok.io/upload';
  ...
  Future btnPressHandler({required String source}) async {
      ...
      rightIcon: GestureDetector(
        onTap: () {
          Navigator.of(context).push(
            MaterialPageRoute(builder: (context) => const LiveVehicle()),
          );
        },
        child: liveButton(),
      ),

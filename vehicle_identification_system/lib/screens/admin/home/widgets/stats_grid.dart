...
class StatsGrid extends StatelessWidget {
  ...
  final graphRed = const Color(0xffff6a69);
  final graphBlue = const Color(0xff7a54ff);
  final graphOrange = const Color(0xffff8f61);
  final graphGreen = const Color(0xff96da47);
  final graphLightBlue = const Color(0xff2ac3ff);
